...
public class ShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>().HasData(
            ...
            new Category(7, "Jugetes y juegos")
            );
        modelBuilder.Entity<Product>().HasData(
            new Product(1, "Radio Digital", "Es una radio de banda ancha", 100, 1),
            new Product(2, "Reloj electronico honda", "Reloj buena sincronizacion", 50, 1),
            new Product(3, "Laptop HP", "Laptop para escritorio y manejo office", 900, 2),
            new Product(4, "Laptop Acer", "Laptop para juegos avanzados de memoria", 1200, 2),
            new Product(5, "Macbook Apple", "Macbook para transporte, gran capacidad", 1500, 2),
            new Product(6, "Samsung Galaxy 2", "Telefono con 5G", 1800, 3),
            new Product(7, "IPhone 4", "Apple dispositivo de gran capacidad", 1500, 3)
            );
        modelBuilder.Entity<Client>().HasData(
            new Client(1, "Jose Martinez", "Av. Plaza 123"),
            new Client(2, "Rolando Urios", "Calle Amapola 321")
            );
    }
}
